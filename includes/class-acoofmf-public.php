        ...
        if ($rel_path) {
            ...
            if (file_exists($file_path) || ( $old_item && isset($old_item['source_path']) )) {
                ...
                if ($proceedUpload && !$restore_backup && file_exists($file_path)) {
                    $update_to_db = true;
                    if ($acoofmService->connect()) {
                        $uploaded = $acoofmService->uploadSingle($file_path, $rel_path, $prefix);
                        ...
                        if(
                            ...
                            $uploaded_original = $acoofmService->uploadSingle($original_file_path, $original_file_rel_path, $prefix);
                ...
                foreach ($attachment_meta['sizes'] as $size => $sub_image) {
                    ...
                    if ( 
                        ...
                        if ($proceedUpload && file_exists($sub_file_path)) {
                            ...
                            if ($acoofmService->connect()) {
                                $uploaded_sub_image = $acoofmService->uploadSingle($sub_file_path, $sub_file_rel_path, $prefix);
                                if(
                                    !$keep_backup && 
        ...
        if (
            ...
            if (isset($item['extra_info']) && !empty($item['extra_info'])) {
                ...
                if (
                    ...
                    foreach ($meta['sizes'] as $sub_image) {
                        if (isset($sub_image['path']) && !empty($sub_image['path'])) {
                            $delete = $acoofmService->deleteSingle($sub_image['path']);
                ...
                if (
                    ...
                    $delete = $acoofmService->deleteSingle($meta['original']['key']);
                    if(isset($delete['success']) && $delete['success']) {
                        $deleted++;
                    }
                }
            ...
            if (isset($item['path']) && !empty($item['path'])) {
                $delete = $acoofmService->deleteSingle($item['path']);
                if(isset($delete['success']) && $delete['success']) {
                    $deleted++;
                }
            }
        ...
        if (
            ...
            if (isset($item['extra_info']) && !empty($item['extra_info'])) {
                ...
                if (
                    ...
                    foreach ($meta['sizes'] as $sub_image) {
                        if (isset($sub_image['path']) && !empty($sub_image['path'])) {
                            $acoofmService->deleteSingle($sub_image['path']);
                        }
                    }
                }
            }
